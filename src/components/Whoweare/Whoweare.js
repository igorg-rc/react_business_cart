    ...
    <div id="aboutUs" className="grey darken-4 teal-text text-lighten-2" style={{ padding: '30px 0' }}>
      ...
      <ScrollAnimation animateIn='fadeIn'>
        ...
        <ScrollAnimation animateIn='bounceInRight' animateOut='bounceOutLeft'>
          <p className="lead">We are web development and IT consultancy company 
          ...
          <p className="lead">We monitor the quality of our code. Each developed module goes through a 
          ...
          <p className="lead">We use the scrum methodology to manage development. The customer can see and control the development 
