...
export default function ContactUs() {
  return (
    <div id="contactUs">
      <div className="teal lighten-2" style={{ padding: '100px 0' }}>
      ...
      <Container>
        ...
        <div className="row">
          <form>
            ...
            <a className="btn button teal lighten-2 teal-text text-lighten-4 left"><span>Hover</span><i className="material-icons right">send</i></a>
          </form>
        </div>
